...
const SpecialtyProducts = () => {
  return (
    <div className='marginal'>
      <h1 className="m-bold text-3xl sm:text-4xl lg:text-5xl text-center text-[#1368b4] font-bold mb-8">Specialty Products Business</h1>
      <div className='bg-[#eaf3f2] p-10 rounded-br-[50px]'>
        <p className='text-[#432c87] text-2xl mb-5 m-semi-bold'>With sustained performance in Agri-business, Specialty Silica and Prebiotics, the Speciality
      ...
      <div className='mt-10'>
        ...
        <p className='text-xl mb-5 text-[#4d4d4f]'>
          Rallis India Limited, our subsidiary, operates in the agricultural inputs sector with over 77 years of experience. We offer products and services
          ...
          districts as well as 70+ countries worldwide. Rallis produce support agriculture and sell them through dealer and distributor networks.
        </p>
        <div className="">
          <div className="flex flex-col md:flex-row text-[#4d4d4f] gap-10">
            ...
            <div className="w-full md:w-1/3">
              <p className="text-xl mt-3">
                <h1 className='m-semi-bold text-2xl text-[#1368b4] mb-3'>Crop Care</h1>
            ...
            <div className="w-full md:w-1/3 flex flex-col space-y-4">
              ...
              <p className="text-xl">
                Launch of multiple products in Crop
                Protection, Biologicals and Specialty
                solutions and Seeds.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Growth in Herbicides and
                Biologicals segments.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Success with Cotton hybrids
                Diggaz and Aatish.
              </p>
              ...
              <p className="text-xl">
                ...
                Flavocide® in CSM business.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Commissioning of an 8,000
                MT automated Water-Soluble
                Fertiliser plant in Akola.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Commercialisation of ‘Metalaxyl-M’ for
                domestic and export markets.
              </p>
              <p className="text-xl mt-3">
                <h1 className='m-semi-bold text-2xl text-[#1368b4] mb-3'>Seeds</h1>
                In our seeds business, we focus on hybrid
            ...
            {/* Column 3 */}
            <div className="w-full h-fit md:w-1/3 bg-[#e7f6fd] rounded-md shadow-sm px-4 py-5 space-y-6">
        ...
        <div className="bg-[#003f84] text-white rounded-br-[50px] p-4 sm:p-6 md:p-4 w-full mt-10">
          ...
          <div className="bg-gradient-to-r from-[#1368b4] to-tranparent p-4 rounded-t-md mb-5">
            ...
            <h1 className="m-semi-bold text-2xl sm:text-3xl font-semibold">Scaling Digital Innovation
              in Seed Production</h1>
          </div>
      ...
      <div className='mt-10'>
        ...
        <p className='text-xl mb-5 text-[#4d4d4f]'>
          ...
          on Highly Dispersible Silica (HDS) for radial tyres and green silica derived from Rice Husk Ash (RHA).
        </p>
        <div className="">
          <div className="flex flex-col md:flex-row text-[#4d4d4f] gap-10">
            ...
            <div className="w-full md:w-1/3">
              <div className=''>
                <h1 className="m-semi-bold text-2xl text-[#1368b4] font-bold ">Value Proposition</h1>
                <ul className="list-disc list-inside text-xl text-[#4d4d4f] marker:text-[#40b2a2] space-y-3">
                  <li>
                  ...
                  <li>
                    Offers customised HDS products for
                    PCR and TBR applications.
                  </li>
              ...
              <ul className="list-disc list-inside text-xl text-[#4d4d4f] marker:text-[#40b2a2] space-y-3">
                ...
                <li>
                  Growing demand for green silica
              ...
              <div className="w-full flex flex-col space-y-6">
                ...
                <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
                <p className="text-xl">
                  Commissioned Line 2, increasing plant
                  capacity for tyre and rubber segments by
                  re-purposing a former food and oral care
                  silica production line.
                </p>

                <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
                <p className="text-xl">
                  Expanded global market reach by
                  strengthening distribution networks and
                  initiating overseas supplies.
                </p>

                <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
                <p className="text-xl">
                  Introduced MicroSphere Silica
                  (MS), a non-fluffy, pearl-form
                  silica for improved handling,
                  processability and tyre performance.
                </p>
                <div className='border-t pt-10'>
                  <p>1 International Organisation for Standardisation</p>
                  <p>2 Registration, Evaluation, Authorisation and Restriction of Chemicals</p>
                  <p>3 International Sustainability and Carbon Certification</p>
                </div>
              </div>
            </div>

            {/* Column 2 */}
            <div className='w-full h-fit md:w-1/3'>
              <div className=" bg-[#e7f6fd] rounded-md shadow-sm px-4 py-5 space-y-6">
                <h1 className="m-semi-bold text-2xl text-[#1368b4]">Roadmap Ahead</h1>
                {[
                  "Improve customer communications and marketing.",
                  "Expand product portfolio in Herbicides, Plant Health and Seeds.",
                  "Strengthen R&D to capture market opportunities.",
            ...
            <div className="w-1/3">
              <div className="bg-[#003f84] text-white rounded-br-[50px] p-4 sm:p-6 md:p-4 w-full">
                ...
                <div className="bg-gradient-to-r from-[#1368b4] to-transparent p-4 rounded-t-md mb-5">
                  ...
                  <h1 className="m-semi-bold text-2xl sm:text-3xl font-semibold">
                ...
                <div className="bg-white text-black rounded-br-4xl mt-0 flex flex-col divide-y divide-gray-300">
                  ...
                  <div className="w-full p-6 text-[#0057a0] text-xl font-medium leading-7">
                    With rising demand for two-wheeler tyres, TREADSIL® 115, a highly
                    dispersible silica tailored for tyre treads was introduced. This
                    product was developed in response to industry demand for improved road
                    grip, fuel efficiency and durability under different road conditions.
                  </div>

                  {/* Bottom Paragraph */}
                  <div className="w-full p-6 text-[#4d4d4f] text-xl font-medium leading-7">
                    R&D efforts were focused on optimising surface area properties,
                    ensuring abrasion resistance, reduced rolling resistance and increased
                    safety in wet and dry conditions.
                    <br />
                    <br />
                    Extensive trials conducted with
                    leading tyre manufacturers and field evaluations showed improvements
                    in tyre performance, including lower heat build-up and better handling
                    at high speeds. The successful validation of TREADSIL® 115 has opened
                    avenues for application in tyre sidewalls and automotive goods,
                    contributing to sustainability targets by enabling low rolling
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col md:flex-row text-[#4d4d4f] gap-10">
            ...
            <div className="w-full md:w-1/3">
              ...
              <h1 className="m-semi-bold text-2xl text-[#1368b4] font-bold mt-5">Value Proposition</h1>
              <ul className="list-disc list-inside text-xl text-[#4d4d4f] marker:text-[#40b2a2] space-y-3">
                <li>
                  Repositioned from a sugar replacer to
                  a fibre ingredient, increasing customer
                  acceptance in the domestic market.
                </li>
                <li>
                  Expanded reach by targeting
              ...
              <ul className="list-disc list-inside text-xl text-[#4d4d4f] marker:text-[#40b2a2] space-y-3">
                <li>
                  Increased customer adoption in pet
            ...
            <div className="w-full md:w-1/3 flex flex-col space-y-4">
              ...
              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Appointed new distributors in USA and
                Europe, strengthening market presence.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Completed customs registration in China,
                enabling exports to a key global market.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Secured several major key accounts
                in baby food, cakes and gummies in
                the domestic market.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Advanced sugar replacement formulations
                with successful trials in gummies,
                cakes and biscuits.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Strengthened presence in pet
                nutrition and animal feed.
              </p>

              <div className="bg-[#ed1a3b] h-[2px] w-[20%]"></div>
              <p className="text-xl">
                Expanded P95, L95 and L55 offerings across
                Trends Australia and Thailand.
              </p>
            </div>
        ...
        <div className="bg-[#003f84] text-white rounded-br-[50px] p-4 sm:p-6 md:p-4 w-full mt-10">
          ...
          <div className="bg-gradient-to-r from-[#1368b4] to-tranparent p-4 rounded-t-md mb-5">
            ...
            <h1 className="m-semi-bold text-2xl sm:text-4xl">No Added Sugar</h1>
          </div>
